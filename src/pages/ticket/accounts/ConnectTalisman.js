...
const DownloadTalismanExtension = () => {
  const extensionLink = 'https://https://www.talisman.xyz/';
  return (
    <Row className="p-md-5 justify-content-center">
      <Col className="d-flex flex-column justify-content-center align-items-center text-center">
        <a
...
export default function TalismanExtensionAccount ({
  setAccountHandler,
  setAddressHandler,
  title,
  prevStepHandler
